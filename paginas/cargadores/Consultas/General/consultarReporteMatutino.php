...
/*$querycheck = "SELECT 
    ...
    c.Estado_Esqueleto, c.Nivel_Aceite_Motor, c.Nivel_Aceite_Hidraulico, c.Nivel_Anticongelante, 
    c.Baterias, c.Luces, c.Neumaticos_Presion_75LB, c.Banda_Alternador_Ventilador, 
    c.Nivel_Aceite_Transmision_Maquina_Encendida, c.Fugas_Maquina_Encendida, 
    c.Frenos_Maquina_Trabajando, c.Presion_Motor_50_PSI_Maquina_Trabajando, 
    c.Temperatura_Motor_100_180_Maquina_Trabajando, c.Horometro_Inicial, c.Horometro_Final,
    c.Observaciones_Estado_Esqueleto, c.Observaciones_Nivel_Aceite_Motor, 
    c.observaciones_Nivel_Aceite_Hidraulico, c.Observaciones_Nivel_Anticongelante, 
    c.Observaciones_Baterias, c.Observaciones_Luces, c.Observaciones_Neumaticos_Presion_75LB, 
    c.observaciones_Banda_Alternador_Ventilador, c.Observaciones_Nivel_Aceite_Maquina_Encendida, 
    c.Observaciones_Fugas_Maquina_Encendida, c.Observaciones_Frenos_Maquina_Trabajando,
    c.Observaciones_Presion_Motor_50_PSI_Maquina_Trabajando, 
    c.Observaciones_Temperatura_Motor_100_180_Maquina_Trabajando, 
    c.Observaciones_Horometro_Inicial, c.Observaciones_Horometro_Final, 
    cmc.reporte_id, cmc.maquina_id,
    cmc.CambiarFiltros, cmc.RevisarMangueras, cmc.EngrasarTazas_Pernos_Gatos, 
    cmc.RevisarSistemaElectrico_Marcha, cmc.RevisarSistema_Avance, 
    cmc.RevisarNivelesFluidoGeneral, cmc.Observaciones_CambiarFiltros,
    cmc.Observaciones_RevisarMangueras, cmc.Observaciones_EngrasarTazasPernosGatos,
    cmc.Observaciones_RevisarSistemaElectrico, 
    cmc.Observaciones_RevisarSistemaAvance,
    cmc.Observaciones_RevisarNivelesFluidoGeneral, cmc.AveriasEncontradasMomento
FROM Cargador c
LEFT JOIN CheckMantenimientoCargadores cmc ON c.Maquina_ID = cmc.maquina_id AND c.id_reporte = cmc.reporte_id
WHERE c.Maquina_ID IN ('0', '1', '2', '3') AND c.Turno = 'Check'
ORDER BY id_reporte DESC";
$resultcheck = mysqli_query($conn, $querycheck);*/

$queryMV = "CALL ConsultaMatutinoVespertino($Turno)";
...
$rowsPerPage = 6; // Ajusta esto según cuántas filas deseas por página
    ...
    $pdf->Cell(0, 5, 'Fecha de registro: '.$datosGenerales[2], 0, 1, 'L', 0, '', 0, false, 'T', 'M');
