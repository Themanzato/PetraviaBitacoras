...
Estado_Esqueleto, Nivel_Aceite_Motor, Nivel_Aceite_Hidraulico, Nivel_Anticongelante, 
Baterias, Luces, Neumaticos_Presion_75LB, Banda_Alternador_Ventilador, 
Nivel_Aceite_Transmision_Maquina_Encendida, Fugas_Maquina_Encendida, 
Frenos_Maquina_Trabajando, Presion_Motor_50_PSI_Maquina_Trabajando, 
Temperatura_Motor_100_180_Maquina_Trabajando, Horometro_Inicial, Horometro_Final,
Observaciones_Estado_Esqueleto, Observaciones_Nivel_Aceite_Motor, 
observaciones_Nivel_Aceite_Hidraulico, Observaciones_Nivel_Anticongelante, 
Observaciones_Baterias, Observaciones_Luces, Observaciones_Neumaticos_Presion_75LB, 
observaciones_Banda_Alternador_Ventilador, Observaciones_Nivel_Aceite_Maquina_Encendida, 
Observaciones_Fugas_Maquina_Encendida, Observaciones_Frenos_Maquina_Trabajando,
...
FROM Cargador 
WHERE (Maquina_ID = '0' OR Maquina_ID = '1' OR Maquina_ID = '2' OR Maquina_ID = '3') AND Turno = 'Vespertino'
...
// Salida del PDF
$pdf->Output('Reporte de Bitácora Vespertino.pdf', 'I');
?>
