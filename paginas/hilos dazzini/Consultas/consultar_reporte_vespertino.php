...
WHERE r.Maquina_ID = $maquina_id AND r.Turno = 'Vespertino'
...
<div class="container mt-5">
        ...
        <div class="text-center mt-4">
            <a href="../hilos_dazzini_principal.php" class="btn btn-secondary btn-custom"><i class="fas fa-arrow-left icono-personalizado"></i>  Volver</a>
        </div>
    </div>
