...
Estado_Equipo, Nivel_Aceite_Motor, Nivel_Anticongelante, Nivel_Aceite_Unidad_Compresion,
Fugas, Ruidos_Extranos, Bateria, Horometro_Inicial, Horometro_Final,
Observaciones_Estado_Equipo, Observaciones_Nivel_Aceite_Motor, Observaciones_Nivel_Anticongelante,
Observaciones_Nivel_Aceite_Unidad_Compresion, Observaciones_Fugas, Observaciones_Ruidos_Extranos,
Observaciones_Bateria, Observaciones_Horometro_Inicial, Observaciones_Horometro_Final,
Observaciones_Adicionales
From Compresor 
WHERE (Maquina_ID = '4' OR Maquina_ID = '5' OR Maquina_ID = '6') AND Turno = 'Vespertino'
