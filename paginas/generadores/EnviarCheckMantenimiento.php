...
$AveriasMomentoSistema = isset($_POST['observacionesMomentoServicio']) ? test_input($_POST['observacionesMomentoServicio']) : '';
...
|| empty($horometroFinal)
    ...
    $sql = "CALL insercionCheckGenerador(
            '$CambiarFiltros' ,
            '$RevisarMangueras' ,
            ...
            '$maquina_id' 
              ...
              $sqlGenerador = "CALL insercionDatosGenerador(
                '$nombre_maquina', 
                '$nombreUsuario',
                '$turno',
                '$estadoEquipo',
        ...
        try {
            ...
            if ($conn->query($sql) === TRUE) {
                ...
                if ($conn->query($sqlGenerador) === TRUE) {
