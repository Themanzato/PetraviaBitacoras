...
<body>
    ...
    <h1 class="text-center">Tabla de Evaluación</h1>
        <h2 class="text-center">Turno Check Mantenimiento</h2>
...
<h1>Averías Encontradas al Momento del Servicio</h1>
    <tbody>
        <tr>
        <td><textarea rows="3" placeholder="Escribe aquí" id="observacionesMomentoServicio" name="observacionesMomentoServicio" class="form-control"></textarea></td>
        </tr>
</table>
