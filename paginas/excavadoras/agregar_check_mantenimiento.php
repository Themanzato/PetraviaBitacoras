...
<body>
    ...
    <h1 class="text-center">Tabla de Evaluación</h1>
        <h2 class="text-center">Turno CheckMantenimiento</h2>
      ...
      <!-- <h1>Observaciones Adicionales</h1>
        ...
        <h1>Check Servicio de Mantenimiento</h1>
        <table class="table table-bordered table-hover">
        <thead class="thead-dark">
        <tr>
    ...
    <tbody>
        <tr>
            ...
            <td><textarea rows="3" placeholder="Escribe aquí" id="observacionesCambiarFiltros" name="observacionesCambiarFiltros"></textarea></td>
        </tr>
        <tr>
            ...
            <td><textarea rows="3" placeholder="Escribe aquí" id="observacionesRevisarMangueras" name="observacionesRevisarMangueras"></textarea></td>
        </tr>
        <tr>
        ...
        <tr>
            <td>Revisar Sistema De Movimientos De Bote</td>
            <td><input type="radio" name="RevisarSistemaMovimientosBote" value="Si"  id="RevisarSistemaMovimientosBote_Si"></td>
            <td><input type="radio" name="RevisarSistemaMovimientosBote" value="No"  id="RevisarSistemaMovimientosBote_no"></td>
            <td><textarea rows="3" placeholder="Escribe aquí" id="observacionesRevisarSistemaMovimientosBote" name="observacionesRevisarSistemaMovimientosBote" class="form-control"></textarea></td>
        </tr>
    </tbody>
</table>
